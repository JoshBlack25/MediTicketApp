...
/**
 * Nurse's Tickets page — functionally identical to
 * clinicstaff.admin.pages.TicketsPage. Reuses the shared TicketDetailsDialog
 * and SummaryCard from za.ac.cput.ui.clinicstaff.components.
