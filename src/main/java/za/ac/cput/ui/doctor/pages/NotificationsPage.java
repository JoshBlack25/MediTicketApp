...
public class NotificationsPage extends JPanel {
    ...
    private JComponent buildHeader() {
        ...
        JLabel subtitle = new JLabel("Updates about your appointments and tickets.");
    ...
    private void loadData() {
        ...
        BaseApiClient.ApiResult<List<Notification>> result =
                ApiClientProvider.getInstance().notifications().findByDoctor(doctorId);
    ...
    private JComponent emptyState() {
        ...
        JLabel sub = new JLabel("You'll see updates about appointments and tickets here.");
